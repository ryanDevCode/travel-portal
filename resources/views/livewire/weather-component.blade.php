        ...
        @if ($weatherData)
            ...
            <div class="row rounded d-flex flex-wrap justify-content-center">
                <div class="col-lg-3 col-sm-12 right text-center pt-2">
                    <img src="{{ url('assets/images/weather-icons/' . $iconCode . '.png') }}"
                        alt="{{ $weatherData['weather'][0]['description'] . $iconCode }}"
                ...
                <div class="col-lg-auto left col-sm-12 border-left border-left-lg-0 mb-3">
                    ...
                    <form action="" class="float float-end d-flex f-w-400">
                        ...
                        <a wire:click="fetchWeatherData" class=""><img
                                src="{{ asset('assets/images/icons/search.png') }}" alt=""
                                style="height: auto; width:40px; padding: 3px;"></a>
                    </form>
                </div>
            </div>
        @else
